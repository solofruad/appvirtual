...
export default class Modal2 extends React.Component {
	...
	render(){
      ...
      <Modal.Body>
        ...
        <Row>
          <Col xs={12} sm={12} md={7} lg={7}>
            <div className="txt-vertical-center"><p className="txt-parrafo cl">Luego de la anterior, se hace la extracción. Se quita el vinipel y la tapa. Se golpea suavemente la base del tarro y delicadamente se saca la planta del frasco. Utilizando agua, se retirara los residuos del gel. </p></div>
          </Col>
          <Col xs={12} sm={12} md={5} lg={5}>
        ...
        <Row>
          ...
          <Col xs={12} sm={12} md={7} lg={7}>
            <div className="txt-vertical-center"><p className="txt-parrafo cl">Se lava las raíces con abundante agua, se quita las hojas basales o “bajeras”.</p></div>
          </Col>
        </Row>
        <hr className="line-divider"></hr>
        <Row>
          <Col xs={12} sm={12} md={7} lg={7}>
            <div className="txt-vertical-center"><p className="txt-parrafo cl">Sembrar en sustrato (1:1 Aserrín y humus solido) esterilizado. También se puede utilizar en la misma proporción cascarilla.</p></div>
          </Col>
          <Col xs={12} sm={12} md={5} lg={5}>
        ...
        <Row>
          ...
          <Col xs={12} sm={12} md={7} lg={7}>
            <div className="txt-vertical-center">
              <p className="txt-parrafo cl">Poner vaso con perforaciones en la base durante dos semanas para que la planta genere un microclima que le permita regular el intercambio gaseoso, temperatura y luminosidad en menor grado. En la segunda semana se levanta de un lado para dejarlo en diagonal y permitir que aumente un poco la salida y entrada de gases. Se sugiere irrigar 20ml de agua día de por medio y un palo de paleta rotulado con el genotipo de planta y la fecha de transplante</p>
              <p className="txt-parrafo cl">Se coloca la planta en radiación solar, durante la primera semana, de 7 am a 10 am y de 2 pm a 5 pm, sin exposición directa al sol (polisombra 50%). En la segunda,  se puede exponer durante todo el día, sin exposición directa al sol (polisombra 50%).</p>
            </div>
          </Col>
        </Row>
        <hr className="line-divider"></hr>
        <Row>
          <Col xs={12} sm={12} md={7} lg={7}>
            <div className="txt-vertical-center"><p className="txt-parrafo cl">Dos semanas después del transplante se retira el vaso y se mantiene 6 semanas más. Aunque el sustrato contiene nutrientes se recomienda realizar una fertilización edáfica o foliar semanal.</p></div>
          </Col>
          <Col xs={12} sm={12} md={5} lg={5}>
        ...
        <Row>
          ...
          <Col xs={12} sm={12} md={7} lg={7}>
            <div className="txt-vertical-center"><p className="txt-parrafo cl">A la 8 semana, la planta puede salir a campo o, coger otra vía, para aumentar la producción del material a través de miniestacas.</p></div>
          </Col>
        </Row>
        <hr className="line-divider"></hr>        
      </Modal.Body>
