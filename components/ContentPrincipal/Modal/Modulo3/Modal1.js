			...
			return	<Modal {...this.props}>
				...
				<Row>
					<Col xs={12} sm={12} md={12} lg={12}>
						<p className="txt-parrafo">Las plantas necesitan un soporte para su desarrollo radicular y sostenimiento: nutrientes, vitaminas, fuente de carbono y reguladores de crecimiento para un  efectivo establecimiento <i>in vitro</i>  y para su posterior adaptación <i>ex vitro</i>.  El medio de cultivo debe cumplir requisitos estandarizados para que la producción de vitroplantas no presente ninguna complicación.</p>
					</Col>
				</Row><br />
				<Row>
					<Col xs={12} sm={12} md={12} lg={12}>
						<p className="txt-center">En este capitulo podrás encontrar lo necesario para continuar con el aprendizaje de <span className="txt-green">cultivo de tejidos vegetales</span>, recuerda tienes al final un ejercicio práctico para que interactues y refuerces aún más en la preparación en un laboratorio. </p>
