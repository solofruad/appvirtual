	...
	let mod=1;
			return	<Modal {...this.props}>
				<Modal.Header closeButton>
					<Modal.Title><Label bsStyle='success'>Introducción! </Label>PREPARACIÓN DE MEDIOS DE CULTIVO</Modal.Title>
				</Modal.Header>
				<Modal.Body>
				<Row>
					<Col xs={12} sm={12} md={12} lg={12}>
						<center><h1 className="txt-grande"><b>PREPARACIÓN DE MEDIOS DE CULTIVO</b></h1><br /></center>
